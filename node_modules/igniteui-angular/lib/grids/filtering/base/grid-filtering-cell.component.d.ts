...
export declare class IgxGridFilteringCellComponent implements AfterViewInit, OnInit, DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxGridFilteringCellComponent, "igx-grid-filtering-cell", never, { "column": { "alias": "column"; "required": false; }; }, {}, never, never, true, never>;
}
