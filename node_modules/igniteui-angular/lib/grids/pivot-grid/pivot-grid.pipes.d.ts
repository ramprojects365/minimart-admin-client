...
import { GridType, PivotGridType } from '../common/grid.interface';
import { IGridSortingStrategy } from '../common/strategy';
import { IgxGridBaseDirective } from '../grid-base.directive';
import { IPivotConfiguration, IPivotDimension, IPivotGridColumn, IPivotGridGroupRecord, IPivotGridHorizontalGroup, IPivotGridRecord, IPivotValue } from './pivot-grid.interface';
...
export declare class IgxPivotRowPipe implements PipeTransform {
    private grid?;
    constructor(grid?: PivotGridType);
    transform(collection: any, config: IPivotConfiguration, cloneStrategy: IDataCloneStrategy, _: Map<any, boolean>, _pipeTrigger?: number, __?: any): IPivotGridRecord[];
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxPivotRowPipe, never>;
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotRowPipe, "pivotGridRow", true>;
}
/**
 * @hidden
...
export declare class IgxPivotAutoTransform implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotAutoTransform, "pivotGridAutoTransform", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotRowExpansionPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotRowExpansionPipe, "pivotGridRowExpansion", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotCellMergingPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotCellMergingPipe, "pivotGridCellMerging", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridHorizontalRowGrouping implements PipeTransform {
    private grid;
    constructor(grid: GridType);
    transform(collection: IPivotGridRecord[], config: IPivotConfiguration, _pipeTrigger?: number, _regroupTrigger?: number): IPivotGridRecord[][];
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxPivotGridHorizontalRowGrouping, never>;
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridHorizontalRowGrouping, "pivotGridHorizontalRowGrouping", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridHorizontalRowCellMerging implements PipeTransform {
    private grid;
    constructor(grid: PivotGridType);
    transform(collection: IPivotGridRecord[], config: IPivotConfiguration, _pipeTrigger?: number): IPivotGridHorizontalGroup[];
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxPivotGridHorizontalRowCellMerging, never>;
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridHorizontalRowCellMerging, "pivotGridHorizontalRowCellMerging", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotColumnPipe implements PipeTransform {
    transform(collection: IPivotGridRecord[], config: IPivotConfiguration, cloneStrategy: IDataCloneStrategy, _: Map<any, boolean>, _pipeTrigger?: number, __?: any): IPivotGridRecord[];
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxPivotColumnPipe, never>;
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotColumnPipe, "pivotGridColumn", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridFilterPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridFilterPipe, "pivotGridFilter", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridColumnSortingPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridColumnSortingPipe, "pivotGridColumnSort", true>;
}
/**
 * @hidden
 */
export declare class IgxPivotGridSortingPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridSortingPipe, "pivotGridSort", true>;
}
/**
 * @hidden
 */
export declare class IgxFilterPivotItemsPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxFilterPivotItemsPipe, "filterPivotItems", true>;
}
...
export declare class IgxPivotGridCellStyleClassesPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridCellStyleClassesPipe, "igxPivotCellStyleClasses", true>;
}
