 ...
 *
 */
export declare class IgxGridToolbarComponent implements OnDestroy {
    private api;
    private iconService;
    private element;
    /**
     ...
     * @internal
     */
    hasActions: IgxGridToolbarActionsComponent;
    /**
     * @hidden
     * @internal
     */
    ...
    constructor(api: GridServiceType, iconService: IgxIconService, element: ElementRef<HTMLElement>);
    /** @hidden @internal */
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxGridToolbarComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxGridToolbarComponent, "igx-grid-toolbar", never, { "showProgress": { "alias": "showProgress"; "required": false; }; "grid": { "alias": "grid"; "required": false; }; }, {}, ["hasActions"], ["[igxGridToolbarTitle],igx-grid-toolbar-title,igc-grid-toolbar-title", "*", "[igxGridToolbarActions],igx-grid-toolbar-actions,igc-grid-toolbar-actions"], true, never>;
    static ngAcceptInputType_showProgress: unknown;
}
