...
export declare class IgxColumnLayoutComponent extends IgxColumnGroupComponent implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxColumnLayoutComponent, "igx-column-layout", never, { "hidden": { "alias": "hidden"; "required": false; }; }, {}, never, ["igx-column,igc-column"], true, never>;
