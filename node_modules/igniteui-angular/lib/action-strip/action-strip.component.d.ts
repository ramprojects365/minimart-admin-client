 ...
 * </igx-action-strip>
 */
export declare class IgxActionStripComponent implements IgxActionStripToken, AfterContentInit, AfterViewInit {
    ...
    constructor(_viewContainer: ViewContainerRef, renderer: Renderer2, el: ElementRef, 
    /** @hidden @internal **/
    cdr: ChangeDetectorRef);
    /**
     * Menu Items list.
